import {
  MiniSearch
} from "./chunk-YK536BGA.js";
import {
  v,
  x
} from "./chunk-4VMHPG2O.js";
import {
  require_react_is
} from "./chunk-BFVX5XM5.js";
...
// node_modules/@react-sigma/graph-search/lib/react-sigma_graph-search.esm.min.js
...
function ruleset(value, root, parent, index2, offset, rules, points, type, props, children, length2) {
  ...
  for (var i2 = 0, j2 = 0, k = 0; i2 < index2; ++i2)
    for (var x3 = 0, y2 = substr(value, post + 1, post = abs(j2 = points[i2])), z = value; x3 < size; ++x3)
      if (z = trim(j2 > 0 ? rule[x3] + " " + y2 : replace(y2, /&\f/g, rule[x3])))
        props[k++] = z;
...
function u(e, t) {
  var n;
  const s2 = e.getGraph().getNodeAttributes(t), a2 = null === (n = e.getNodeDisplayData(t)) || void 0 === n ? void 0 : n.label;
  return Object.assign({ type: "nodes", itemId: `nodes-${t}`, id: t, label: a2 }, Object.keys(s2).reduce((e2, t2) => Object.assign(Object.assign({}, e2), { [`prop_${t2}`]: s2[t2] }), {}));
}
function p(e, t) {
  var n;
  const s2 = e.getGraph().getEdgeAttributes(t), a2 = null === (n = e.getEdgeDisplayData(t)) || void 0 === n ? void 0 : n.label;
  return Object.assign({ type: "edges", itemId: `edges-${t}`, id: t, label: a2 }, Object.keys(s2).reduce((e2, t2) => Object.assign(Object.assign({}, e2), { [`prop_${t2}`]: s2[t2] }), {}));
}
var m = { index: new MiniSearch({ fields: [] }) };
var b = (0, import_react11.createContext)(m);
var f = ({ children: t, minisearchOptions: s2 }) => {
  const [r2, i2] = (0, import_react11.useState)(m), c2 = v();
  return (0, import_react11.useEffect)(() => {
    const e = new MiniSearch(Object.assign(Object.assign({}, s2), { idField: "itemId", fields: (null == s2 ? void 0 : s2.fields) ? ["label", ...s2.fields.filter((e2) => "label" !== e2)] : ["label"], storeFields: (null == s2 ? void 0 : s2.storeFields) ? ["itemId", "id", "type", ...s2.storeFields.filter((e2) => !["itemId", "id", "type"].includes(e2))] : ["itemId", "id", "type"], processTerm: (null == s2 ? void 0 : s2.processTerm) ? null == s2 ? void 0 : s2.processTerm : (e2, t3) => e2.normalize("NFD").replace(/[\u0300-\u036f]/g, "").toLowerCase() })), t2 = c2.getGraph();
    function a2(t3) {
      e.has(`nodes-${t3.key}`) ? e.replace(u(c2, t3.key)) : e.add(u(c2, t3.key));
    }
    function r3(t3) {
      e.has(`nodes-${t3.key}`) && e.discard(`nodes-${t3.key}`);
    }
    function o2(t3) {
      e.has(`edges-${t3.key}`) ? e.replace(p(c2, t3.key)) : e.add(p(c2, t3.key));
    }
    function l2(t3) {
      e.has(`edges-${t3.key}`) && e.discard(`edges-${t3.key}`);
    }
    return e.addAll(t2.nodes().map((e2) => u(c2, e2))), e.addAll(t2.edges().map((e2) => p(c2, e2))), t2.on("nodeAdded", a2), t2.on("nodeAttributesUpdated", a2), t2.on("nodeDropped", r3), t2.on("edgeAdded", o2), t2.on("edgeAttributesUpdated", o2), t2.on("edgeDropped", l2), i2({ index: e }), () => {
      t2.off("nodeAdded", a2), t2.off("nodeAttributesUpdated", a2), t2.off("nodeDropped", r3), t2.off("edgeAdded", o2), t2.off("edgeAttributesUpdated", o2), t2.off("edgeDropped", l2);
    };
  }, [c2, s2]), import_react11.default.createElement(b.Provider, { value: r2 }, t);
};
function y(e, t, n, s2) {
  return new (n || (n = Promise))(function(a2, r2) {
    function o2(e2) {
      try {
        i2(s2.next(e2));
      } catch (e3) {
    ...
    function i2(e2) {
      var t2;
      e2.done ? a2(e2.value) : (t2 = e2.value, t2 instanceof n ? t2 : new n(function(e3) {
        e3(t2);
      })).then(o2, l2);
    }
    i2((s2 = s2.apply(e, t || [])).next());
  });
}
function h(e) {
  const { index: t } = (0, import_react11.useContext)(b);
  return { search: (0, import_react11.useCallback)((n, s2) => y(this, void 0, void 0, function* () {
    return t.search(n, Object.assign(Object.assign({ prefix: true, fuzzy: 0.2, boost: { label: 2 } }, e || {}), { filter: s2 ? (e2) => e2.type === s2 : void 0 })).map((e2) => ({ id: e2.id, type: e2.type }));
  }), [t, e]) };
}
var O = ({ label: e, color: t, hidden: n, labels: s2 = {} }) => import_react11.default.createElement("div", { className: "node" }, import_react11.default.createElement("span", { className: "render " + (n ? "circle" : "disc"), style: { backgroundColor: t || "#000" } }), import_react11.default.createElement("span", { className: `label ${n ? "text-muted" : ""} ${e ? "" : "text-italic"}` }, e || s2.no_label || "No label"));
var v2 = ({ id: t, labels: n }) => {
  const s2 = v(), r2 = (0, import_react11.useMemo)(() => {
    const e = s2.getGraph().getNodeAttributes(t), n2 = s2.getSetting("nodeReducer");
    return Object.assign(Object.assign({ color: s2.getSetting("defaultNodeColor") }, e), n2 ? n2(t, e) : {});
  }, [s2, t]);
  return import_react11.default.createElement(O, Object.assign({}, r2, { labels: n }));
};
var j = ({ label: e, color: t, source: n, target: s2, hidden: r2, directed: o2, labels: l2 = {} }) => import_react11.default.createElement("div", { className: "edge" }, import_react11.default.createElement(O, Object.assign({}, n, { labels: l2 })), import_react11.default.createElement("div", { className: "body" }, import_react11.default.createElement("div", { className: "render" }, import_react11.default.createElement("span", { className: r2 ? "dotted" : "dash", style: { borderColor: t || "#000" } }), " ", o2 && import_react11.default.createElement("span", { className: "arrow", style: { borderTopColor: t || "#000" } })), import_react11.default.createElement("span", { className: `label ${r2 ? "text-muted" : ""} ${e ? "" : "fst-italic"}` }, e || l2.no_label || "No label")), import_react11.default.createElement(O, Object.assign({}, s2, { labels: l2 })));
var E = ({ id: t, labels: n }) => {
  const s2 = v(), r2 = (0, import_react11.useMemo)(() => {
    const e = s2.getGraph().getEdgeAttributes(t), n2 = s2.getSetting("nodeReducer"), a2 = s2.getSetting("edgeReducer"), r3 = s2.getGraph().getNodeAttributes(s2.getGraph().source(t)), o2 = s2.getGraph().getNodeAttributes(s2.getGraph().target(t));
    return Object.assign(Object.assign(Object.assign({ color: s2.getSetting("defaultEdgeColor"), directed: s2.getGraph().isDirected(t) }, e), a2 ? a2(t, e) : {}), { source: Object.assign(Object.assign({ color: s2.getSetting("defaultNodeColor") }, r3), n2 ? n2(t, r3) : {}), target: Object.assign(Object.assign({ color: s2.getSetting("defaultNodeColor") }, o2), n2 ? n2(t, o2) : {}) });
  }, [s2, t]);
  return import_react11.default.createElement(j, Object.assign({}, r2, { labels: n }));
};
var N;
function w2() {
  return w2 = Object.assign ? Object.assign.bind() : function(e) {
    for (var t = 1; t < arguments.length; t++) {
      var n = arguments[t];
      for (var s2 in n) ({}).hasOwnProperty.call(n, s2) && (e[s2] = n[s2]);
    }
    return e;
  }, w2.apply(null, arguments);
}
var x2 = function(e) {
  return s.createElement("svg", w2({ xmlns: "http://www.w3.org/2000/svg", "aria-hidden": "true", className: "magnifying-glass_svg__svg-inline--fa magnifying-glass_svg__fa-magnifying-glass magnifying-glass_svg__fa-w-14", "data-icon": "compress", "data-prefix": "fas", viewBox: "0 0 512 512", width: "1em", height: "1em" }, e), N || (N = s.createElement("path", { d: "M416 208c0 45.9-14.9 88.3-40 122.7l126.6 126.7c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0s208 93.1 208 208M208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288" })));
};
var _ = ({ className: e, onChange: n, onFocus: s2, postSearchResult: r2, type: o2, value: i2, children: u2, labels: p2 = {} }) => {
  const { search: m2 } = h(), b2 = (0, import_react11.useCallback)((e2) => y(void 0, void 0, void 0, function* () {
    s2 && s2(null);
    const t = yield m2(e2, o2);
    return r2 ? r2(t) : t;
  }), [o2, r2, m2, s2]), f2 = (0, import_react11.useMemo)(() => {
    return e2 = u2 ? u2[0] : import_react11.default.createElement(x2, null), function() {
      return import_react11.default.createElement("div", { className: "dropdown-indicator" }, e2);
    };
    var e2;
  }, [u2]), O2 = (0, import_react11.useMemo)(() => /* @__PURE__ */ function(e2) {
    return function(t) {
      const { data: n2, innerProps: s3, className: r3, isFocused: o3, innerRef: i3, getStyles: c2 } = t;
      return (0, import_react11.useEffect)(() => {
        e2 && o3 && e2(n2);
      }, [o3, n2]), import_react11.default.createElement("div", Object.assign({}, s3, { style: c2("option", t), className: `${r3 || ""} ${o3 ? "selected" : ""} option hoverable text-ellipsis`, ref: i3 }), "nodes" === n2.type && import_react11.default.createElement(v2, { id: n2.id }), "edges" === n2.type && import_react11.default.createElement(E, { id: n2.id }), "message" === n2.type && import_react11.default.createElement("div", { className: "message" }, n2.message));
    };
  }(s2), [s2]), j2 = (0, import_react11.useMemo)(() => /* @__PURE__ */ function(e2) {
    return function(t) {
      const { getStyles: n2, innerProps: s3 } = t;
      return import_react11.default.createElement("div", Object.assign({}, s3, { style: n2("singleValue", t) }), "nodes" === t.data.type && import_react11.default.createElement(v2, { id: t.data.id, labels: e2 }), "edges" === t.data.type && import_react11.default.createElement(E, { id: t.data.id, labels: e2 }));
    };
  }(p2), [p2]), N2 = (0, import_react11.useMemo)(() => /* @__PURE__ */ function(e2 = {}) {
    return function(t) {
      return import_react11.default.createElement("div", { className: "message text-center" }, t.selectProps.inputValue.length > 0 ? import_react11.default.createElement("span", null, e2.no_result_found || "No result found") : import_react11.default.createElement("span", { className: "text-muted" }, e2.type_something_to_search || "Type something to search"));
    };
  }(p2), [p2]);
  return import_react11.default.createElement(AsyncSelect$1, { classNamePrefix: "react-select", className: `${e || ""} graph-search`, isClearable: true, placeholder: p2.placeholder || "Search...", value: i2 || null, loadOptions: x(b2, 150), onChange: n, onMenuClose: () => s2 && s2(null), components: { SingleValue: j2, Option: O2, NoOptionsMessage: N2, DropdownIndicator: f2 }, styles: { menu: (e2) => Object.assign(Object.assign({}, e2), { borderRadius: 0 }), control: (e2) => Object.assign(Object.assign({}, e2), { borderRadius: 0 }), valueContainer: (e2) => Object.assign(Object.assign({}, e2), { flexWrap: "nowrap" }) } });
};
var S = (e) => {
  var { minisearchOptions: t } = e, n = function(e2, t2) {
    var n2 = {};
    for (var s2 in e2) Object.prototype.hasOwnProperty.call(e2, s2) && t2.indexOf(s2) < 0 && (n2[s2] = e2[s2]);
    if (null != e2 && "function" == typeof Object.getOwnPropertySymbols) {
      var a2 = 0;
      for (s2 = Object.getOwnPropertySymbols(e2); a2 < s2.length; a2++) t2.indexOf(s2[a2]) < 0 && Object.prototype.propertyIsEnumerable.call(e2, s2[a2]) && (n2[s2[a2]] = e2[s2[a2]]);
    }
    return n2;
  }(e, ["minisearchOptions"]);
  return import_react11.default.createElement(f, { minisearchOptions: t }, import_react11.default.createElement(_, Object.assign({}, n)));
};
export {
  j as Edge,
  E as EdgeById,
  S as GraphSearch,
  b as GraphSearchContext,
  f as GraphSearchContextProvider,
  _ as GraphSearchInput,
  O as Node,
  v2 as NodeById,
  h as useGraphSearch
};
//# sourceMappingURL=@react-sigma_graph-search.js.map
